...
def main():
    ...
    # 삭제 필요
    # lidar_list_dir_path = 'E:\\gongju_univ_sampledata_2minute_interior\\20230818_142349\\PCD'
    # files = ['E:\\gongju_univ_sampledata_2minute_interior\\20230818_142349\\PCD\\path_lidar_list.txt']
        ...
        with open(file_name, 'rb') as f:  # 취득데이터 이름
            ...
            while 1:
                ...
                try:
                    ...
                    if (pcd_num % 10 ==0 or pcd_num % 10 == 3or pcd_num % 10 ==6 or pcd_num % 10 ==8):
