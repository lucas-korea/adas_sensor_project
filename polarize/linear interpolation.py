...
file_list = os.listdir('E:\\15000set\\polar_drive_image')
cnt = 0
for file in file_list:
    print(file, cnt)
    cnt +=1
    original_color_image = plt.imread('E:\\15000set\\polar_drive_image\\' + file)

    # Set the new shape for the resized image
    new_shape = (512*2, 612*2)
    ...
    plt.imsave('E:\\15000set\\polar_drive_image_interpolation\\' + file, resized_color_image)
