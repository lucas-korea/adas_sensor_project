...
def main():
    ...
    for file_name in lidar_file_list:
        ...
        # if os.path.isfile(lidar_list_dir_path + '\\' + 'image_frame_number.txt'):
        #     os.remove(lidar_list_dir_path + '\\' + 'image_frame_number.txt')
                ...
                try:
                    ...
                    for i in range(64):
                        ...
                        if find_0deg(data):
                            ...
                            # frame_number = round(int(frame_number) / 1.3315)
                            tick_ct = header[2]
